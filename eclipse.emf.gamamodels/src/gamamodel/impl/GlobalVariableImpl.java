 ...
 * </p>
 * <ul>
 *   <li>{@link gamamodel.impl.GlobalVariableImpl#getGvarName <em>Gvar Name</em>}</li>
 *   <li>{@link gamamodel.impl.GlobalVariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link gamamodel.impl.GlobalVariableImpl#getInitValue <em>Init Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GlobalVariableImpl extends MinimalEObjectImpl.Container implements GlobalVariable {
	...
	protected EClass eStaticClass() {
		return GamamodelPackage.Literals.GLOBAL_VARIABLE;
	}
	...
	public void setGvarName(String newGvarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamamodelPackage.GLOBAL_VARIABLE__GVAR_NAME, oldGvarName, gvarName));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamamodelPackage.GLOBAL_VARIABLE__TYPE, oldType, type));
	}
	...
	public void setInitValue(String newInitValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamamodelPackage.GLOBAL_VARIABLE__INIT_VALUE, oldInitValue, initValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GamamodelPackage.GLOBAL_VARIABLE__GVAR_NAME:
				return getGvarName();
			case GamamodelPackage.GLOBAL_VARIABLE__TYPE:
				return getType();
			case GamamodelPackage.GLOBAL_VARIABLE__INIT_VALUE:
				return getInitValue();
		}
