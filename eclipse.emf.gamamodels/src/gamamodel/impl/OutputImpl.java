 ...
 *   <li>{@link gamamodel.impl.OutputImpl#getName <em>Name</em>}</li>
...
public class OutputImpl extends MinimalEObjectImpl.Container implements Output {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamamodelPackage.OUTPUT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GamamodelPackage.OUTPUT__NAME:
				return getName();
